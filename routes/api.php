...
Route::get('partner-questionairre-activity', 'apiPartnerController@partnerQuestionairreActivity');
Route::get('partner-questionairre-record', 'apiPartnerController@partnerQuestionairreRecord');
Route::get('partner-questionairre-soiltest', 'apiPartnerController@partnerQuestionairreSoilTest');