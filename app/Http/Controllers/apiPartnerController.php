        ...
        try 
        {
            ...
            if($partner){ 
                ...
                if($vendor_service)
                {
                    ...
                    //echo $table_name_id.",".$table_name_vendor_id.">";
                    //echo $vendorData1->$table_name_id.",".$vendorData1->$table_name_vendor_id; exit;

                    //echo $table_name_id.",".$table_name_vendor_id; exit;
