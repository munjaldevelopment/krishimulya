...
class SoilTestOrdersCrudController extends CrudController
{
    ...
    public function downloadSoilTest(Request $request)
    {
        ...
        if(isset($result['data']))
        {
            ...
            if (Storage::disk('public')->exists($filename)) {
                $html = $html_data = Storage::disk('public')->get($filename);
                ...
                $html_data = str_replace("data:image/png;base64,", env('APP_URL')."/uploads/logo/512-png-short.png", $html_data);

                $html_data = str_replace('margin-top:-30px;', 'margin-top:-30px;text-align:center;', $html_data);
                ...
                $(".generate-report").bind("click", function() {
                    ...
                    $(".Table1 tr").each(function (tr_row) {
                        $("td", this).each(function (column, td_row) {
                ...
                $html_data = str_replace('</body>', $ajaxcode.'</body>', $html_data);
                echo $html_data; exit;
            }
        }
        else
        {
            return redirect(backpack_url('soiltestorders'));
        }
    }
    ...
    public function saveSoilTest(Request $request)
    {
        ...
        if(($tableData) && ($isExists == 0))
        {
            ...
            {
                $tableRow = explode("|", $row);
                $first_col = strip_tags(trim($tableRow[0]));
                ...
                if($k == 1 || $k == 2 || $k == 3 || $k == 5)
                {
                    ...
                    $fifth_col = strip_tags(trim($tableRow[4]));
                    $sixth_col = strip_tags(trim($tableRow[5]));
                    $seventh_col = strip_tags(trim($tableRow[6]));
                    $eigth_col = strip_tags(trim($tableRow[7]));

                    if($k == 1)
                    {
                        $date = date('Y-m-d H:i:s');
                        $soil_test_order_data_id = DB::table('soil_test_order_data')->insertGetId(['soil_test_order_id' => $soil_test_order_id, 'farmer_name' => $second_col, 'farmer_code' => $fourth_col, 'crop_grown' => $sixth_col, 'sample_number' => $eigth_col, 'created_at' => $date, 'updated_at' => $date]);
                    }
                    else if($k == 2)
                    {
                        $sampling_date = $sample_testing_date =  NULL;
                        if($fourth_col != "Invalid Date")
                        {
                            $sampling_date = date('Y-m-d', strtotime($fourth_col));
                        }

                        $sixth_col = str_replace(" at", "", $sixth_col);
                        $sample_testing_date = date('Y-m-d H:i:s', strtotime($sixth_col));
                        DB::table('soil_test_order_data')->where('id', $soil_test_order_data_id)->update(['field_size' => $second_col, 'sampling_date' => $sampling_date, 'sample_testing_date' => $sample_testing_date, 'region' => $eigth_col]);
                    }
                    else if($k == 3)
                    {
                        DB::table('soil_test_order_data')->where('id', $soil_test_order_data_id)->update(['previous_season' => $second_col, 'sample_collected_by' => $fourth_col, 'yield_goal' => $sixth_col, 'previous_crop' => $eigth_col]);
                    }
                    //echo $first_col.",".$eigth_col."<br />";
                }
                else if($k > 5)
                {
                    if($first_col == "" || $first_col == "Fertilizer Recommendation:")
                    {
                        if($first_col == "Fertilizer Recommendation:")
                        {
                            $second_col = strip_tags(trim($tableRow[1]));
                            $third_col = strip_tags(trim($tableRow[2]));
                            $third_col = str_replace("Comments:", "", $third_col);
                            DB::table('soil_test_order_data')->where('id', $soil_test_order_data_id)->update(['recommendation' => $second_col, 'comments' => $third_col]);
                        }
                    }
                    else
                    {
