 ...
 */
class TractorSellEnquiryPartnerCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->enableExportButtons(); CRUD::setRoute(config('backpack.base.route_prefix') . '/tractor_sell_enquiry_partner');
