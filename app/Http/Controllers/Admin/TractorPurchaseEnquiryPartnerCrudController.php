 ...
 */
class TractorPurchaseEnquiryPartnerCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->enableExportButtons(); CRUD::setRoute(config('backpack.base.route_prefix') . '/tractor_purchase_enquiry_partner');
        ...
        $this->crud->addColumn([
         ...
         $this->crud->addFilter([ // select2 filter
                ...
                if($customers1)
                {
                    ...
                    {
                        $all_customers1[$row1->id] = ($row1->name != '') ? $row1->name : $row1->sphone;
                    }
                }
